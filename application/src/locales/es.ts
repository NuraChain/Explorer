...
export const es: Dictionary = {
    ...
    // --- Verified source ----------------------------------------------------------------------
    'contract.verified.full': 'Código fuente verificado',
    'contract.verified.partial': 'Código fuente verificado - coincidencia parcial',
    'contract.verified.detail': '{name}, compilado con solc {compiler}',
    'contract.verified.partial.hint': 'El código desplegado coincide; solo difiere la cola de metadatos, y basta con un comentario movido o una ruta de archivo distinta para cambiarla. Las instrucciones están probadas; los comentarios que las rodean, no.',
    'contract.verified.viaImplementation': 'El código publicado pertenece a la implementación a la que reenvía esta dirección.',
    'contract.source': 'Código fuente',
    'contract.source.optimized': 'optimizador activo, {runs} pasadas',
    'contract.source.unoptimized': 'optimizador inactivo',
    'contract.source.copyAbi': 'Copiar ABI',

    // --- Publishing source --------------------------------------------------------------------
    'verify.cta': 'Publicar el código',
    'verify.title': 'Verificar {short}',
    'verify.heading': 'Publicar y verificar el código fuente',
    'verify.intro': 'Aquí nada se acepta por confianza. Este explorador compila lo que envías y solo lo acepta si el resultado es el bytecode ya desplegado en esta dirección: no hay cuenta que crear ni nadie a quien esperar.',
    'verify.offline': 'No se pudo obtener la lista de compiladores, así que solo pueden usarse las versiones que ya están en este servidor. Pide a quien lo administra que añada la que necesitas.',
    'verify.kind': 'Formato de envío',
    'verify.kind.single': 'Archivo único',
    'verify.kind.json': 'Standard JSON',
    'verify.compiler': 'Versión del compilador',
    'verify.compiler.hint': 'La compilación exacta, no solo la versión: la salida de solc cambia entre parches. Un punto marca las que ya están en este servidor.',
    'verify.evmVersion': 'Versión de la EVM',
    'verify.evmVersion.default': 'La predeterminada del compilador',
    'verify.evmVersion.hint': 'Déjalo en la predeterminada salvo que el contrato se compilara con un valor explícito. Nombrar otra cambia los opcodes generados.',
    'verify.name': 'Nombre del contrato',
    'verify.name.hint': 'Opcional. Si se deja vacío se prueba cada contrato del código.',
    'verify.fileName': 'Nombre del archivo',
    'verify.fileName.hint': 'La ruta con la que se compiló el archivo. Entra en el hash de los metadatos, así que una equivocada convierte una coincidencia completa en parcial.',
    'verify.optimizer': 'Optimizador',
    'verify.optimizer.enabled': 'Activado',
    'verify.optimizer.hint': 'Deben coincidir con los del despliegue; si no, el bytecode tampoco coincidirá.',
    'verify.runs': 'Pasadas del optimizador',
    'verify.license': 'Licencia',
    'verify.source': 'Código Solidity',
    'verify.source.placeholder': 'Pega el contrato entero, con sus imports.',
    'verify.json': 'Entrada Standard JSON',
    'verify.json.placeholder': 'Pega la entrada solc standard-json que produjo tu compilación.',
    'verify.json.hint': 'Sus ajustes se usan tal cual: remappings, direcciones de bibliotecas y viaIR incluidos. Solo se amplía la selección de salida.',
    'verify.submit': 'Verificar y publicar',
    'verify.submit.hint': 'Compilar tarda unos segundos y se ejecuta un envío cada vez.',
    'verify.failed.hint': 'Una discrepancia casi siempre es la versión del compilador, el ajuste del optimizador o el número de pasadas. Compara cada uno con lo usado al desplegar.',
    'verify.done.detail': 'El código de {name} ya está publicado en este contrato, y sus funciones tienen nombre y se pueden llamar.',
    'verify.done.open': 'Abrir el contrato',
