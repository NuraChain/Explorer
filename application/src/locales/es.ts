...
export const es: Dictionary = {
    ...
    'governance.hint': 'Cada propuesta que un gobernador de esta cadena ha registrado, leída de los eventos que él mismo escribió.',
    'governance.governors': 'Gobernadores',
    'governance.governor.unnamed': 'Gobernador sin nombre',
    'governance.governor.proposals': '{count} propuestas',
    'governance.filter': 'Resultado',
    'governance.filter.open': 'Abiertas',
    'governance.filter.passed': 'Aprobadas',
    'governance.filter.failed': 'Rechazadas',
    'governance.filter.governor': 'Gobernador',
    'governance.untitled': 'Propuesta sin título',
    'governance.proposedBy': 'Propuesta de',
    'governance.voters': '{count} votantes',
    'governance.ends.block': 'La votación termina en el bloque {block}',
    'governance.ended.block': 'La votación terminó en el bloque {block}',
    'governance.ends.date': 'La votación termina el {date}',
    'governance.ended.date': 'La votación terminó el {date}',
    'governance.empty.chain.title': 'No hay gobernador en esta cadena',
    'governance.empty.chain.hint': 'Esta sección se encuentra sola: aparece cuando se despliega un gobernador y registra su primera propuesta.',
    'governance.empty.title': 'Aún no hay propuestas',
    'governance.empty.hint': 'Una propuesta aparece aquí en cuanto se indexa su creación.',
    'governance.empty.filtered.title': 'Ninguna propuesta coincide',
    'governance.empty.filtered.hint': 'Nada en este registro encaja con ese filtro.',
    'governance.total': '{count} propuestas registradas.',
    'governance.state.pending': 'Pendiente',
    'governance.state.active': 'En votación',
    'governance.state.canceled': 'Cancelada',
    'governance.state.defeated': 'Rechazada',
    'governance.state.succeeded': 'Aprobada',
    'governance.state.queued': 'En cola',
    'governance.state.expired': 'Caducada',
    'governance.state.executed': 'Ejecutada',
    'governance.state.closed': 'Cerrada',
    'governance.support.for': 'A favor',
    'governance.support.against': 'En contra',
    'governance.support.abstain': 'Abstención',
    'governance.support.other': 'Otro',
    'governance.share': '{percent}%',
    'governance.quorum': 'Quórum',
    'governance.quorum.unknown': 'Este gobernador no dijo qué quórum necesitaba la propuesta.',
    'governance.tally': 'La votación',
    'governance.proposal.title': 'Propuesta',
    'governance.proposal.missing.title': 'No existe esa propuesta',
    'governance.proposal.missing.hint': 'No se ha indexado nada con ese id para este gobernador.',
    'governance.live': 'el gobernador informa {state}',
    'governance.governor': 'Gobernador',
    'governance.id': 'Id de propuesta',
    'governance.voteStart': 'Apertura del voto',
    'governance.voteEnd': 'Cierre del voto',
    'governance.atBlock': 'Bloque {block}',
    'governance.counting': 'Recuento',
    'governance.timeline': 'Historial',
    'governance.stage.created': 'Propuesta',
    'governance.stage.queued': 'En cola',
    'governance.stage.executed': 'Ejecutada',
    'governance.stage.canceled': 'Cancelada',
    'governance.eta': 'Ejecutable desde {date}',
    'governance.description': 'La propuesta',
    'governance.description.none': 'Esta propuesta no lleva descripción.',
    'governance.calls': 'Qué hace',
    'governance.calls.none': 'Esta propuesta no llama a nada',
    'governance.calls.none.hint': 'Registra una posición en lugar de mover algo en la cadena.',
    'governance.call.to': 'A',
    'governance.call.value': 'Valor',
    'governance.call.data': 'Calldata',
    'governance.ballots': 'Votos ({count})',
    'governance.ballots.empty': 'Aún no hay votos',
    'governance.ballots.empty.hint': 'Cada voto emitido sobre esta propuesta aparece aquí, con su peso y su motivo.',
    'governance.act.title': 'Participar',
    'governance.act.connect': 'Conecta una cartera en esta cadena para votar, delegar o hacer avanzar una propuesta.',
    'governance.act.vote': 'Tu voto',
    'governance.act.submit': 'Emitir voto',
    'governance.act.reason': 'Motivo',
    'governance.act.reason.placeholder': 'Por qué votaste así (opcional)',
    'governance.act.power': 'Tu poder de voto en la instantánea: {weight}',
    'governance.act.voted': 'Ya has votado esta propuesta.',
    'governance.act.sent': 'Enviado a tu cartera.',
    'governance.act.queue': 'Encolar',
    'governance.act.queue.hint': 'Esta propuesta se aprobó. Encolarla inicia su bloqueo temporal.',
    'governance.act.execute': 'Ejecutar',
    'governance.act.execute.hint': 'El bloqueo temporal tiene esta propuesta. Ejecutarla lanza sus llamadas.',
    'governance.act.delegate': 'Poder de voto',
    'governance.act.delegate.hint': 'Los votos solo cuentan una vez delegados: a ti mismo o a quien vote por ti.',
    'governance.act.delegate.self': 'Delegar en mí',
    'governance.act.delegate.submit': 'Delegar',
    'governance.act.delegate.placeholder': 'Dirección, o vacío para la tuya',
    'governance.act.delegate.token': 'Token de voto:',
    'governance.act.badAddress': 'Eso no es una dirección.',
