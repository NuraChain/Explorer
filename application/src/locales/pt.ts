...
export const pt: Dictionary = {
    ...
    'governance.hint': 'Cada proposta que um governador desta cadeia registou, lida dos eventos que ele próprio escreveu.',
    'governance.governors': 'Governadores',
    'governance.governor.unnamed': 'Governador sem nome',
    'governance.governor.proposals': '{count} propostas',
    'governance.filter': 'Resultado',
    'governance.filter.open': 'Abertas',
    'governance.filter.passed': 'Aprovadas',
    'governance.filter.failed': 'Rejeitadas',
    'governance.filter.governor': 'Governador',
    'governance.untitled': 'Proposta sem título',
    'governance.proposedBy': 'Proposta de',
    'governance.voters': '{count} votantes',
    'governance.ends.block': 'A votação termina no bloco {block}',
    'governance.ended.block': 'A votação terminou no bloco {block}',
    'governance.ends.date': 'A votação termina em {date}',
    'governance.ended.date': 'A votação terminou em {date}',
    'governance.empty.chain.title': 'Nenhum governador nesta cadeia',
    'governance.empty.chain.hint': 'Esta secção encontra-se sozinha: aparece quando um governador é implantado e regista a primeira proposta.',
    'governance.empty.title': 'Ainda sem propostas',
    'governance.empty.hint': 'Uma proposta aparece aqui assim que a sua criação é indexada.',
    'governance.empty.filtered.title': 'Nenhuma proposta corresponde',
    'governance.empty.filtered.hint': 'Nada neste registo encaixa nesse filtro.',
    'governance.total': '{count} propostas registadas.',
    'governance.state.pending': 'Pendente',
    'governance.state.active': 'Em votação',
    'governance.state.canceled': 'Cancelada',
    'governance.state.defeated': 'Rejeitada',
    'governance.state.succeeded': 'Aprovada',
    'governance.state.queued': 'Em fila',
    'governance.state.expired': 'Expirada',
    'governance.state.executed': 'Executada',
    'governance.state.closed': 'Fechada',
    'governance.support.for': 'A favor',
    'governance.support.against': 'Contra',
    'governance.support.abstain': 'Abstenção',
    'governance.support.other': 'Outro',
    'governance.share': '{percent}%',
    'governance.quorum': 'Quórum',
    'governance.quorum.unknown': 'Este governador não disse que quórum a proposta precisava.',
    'governance.tally': 'A votação',
    'governance.proposal.title': 'Proposta',
    'governance.proposal.missing.title': 'Proposta inexistente',
    'governance.proposal.missing.hint': 'Nada foi indexado com esse id para este governador.',
    'governance.live': 'o governador reporta {state}',
    'governance.governor': 'Governador',
    'governance.id': 'Id da proposta',
    'governance.voteStart': 'Abertura do voto',
    'governance.voteEnd': 'Fecho do voto',
    'governance.atBlock': 'Bloco {block}',
    'governance.counting': 'Contagem',
    'governance.timeline': 'Histórico',
    'governance.stage.created': 'Proposta',
    'governance.stage.queued': 'Em fila',
    'governance.stage.executed': 'Executada',
    'governance.stage.canceled': 'Cancelada',
    'governance.eta': 'Executável a partir de {date}',
    'governance.description': 'A proposta',
    'governance.description.none': 'Esta proposta não tem descrição.',
    'governance.calls': 'O que faz',
    'governance.calls.none': 'Esta proposta não chama nada',
    'governance.calls.none.hint': 'Regista uma posição em vez de mover algo na cadeia.',
    'governance.call.to': 'Para',
    ...
    'governance.ballots.empty.hint': 'Cada voto dado nesta proposta aparece aqui, com o seu peso e o seu motivo.',
    'governance.act.title': 'Participar',
    'governance.act.connect': 'Liga uma carteira nesta cadeia para votar, delegar ou fazer avançar uma proposta.',
    'governance.act.vote': 'O teu voto',
    'governance.act.submit': 'Votar',
    'governance.act.reason': 'Motivo',
    'governance.act.reason.placeholder': 'Porque votaste assim (opcional)',
    'governance.act.power': 'O teu poder de voto no instantâneo: {weight}',
    'governance.act.voted': 'Já votaste nesta proposta.',
    'governance.act.sent': 'Enviado para a tua carteira.',
    'governance.act.queue': 'Enfileirar',
    'governance.act.queue.hint': 'Esta proposta passou. Enfileirá-la inicia o seu bloqueio temporal.',
    'governance.act.execute': 'Executar',
    'governance.act.execute.hint': 'O bloqueio temporal tem esta proposta. Executar corre as suas chamadas.',
    'governance.act.delegate': 'Poder de voto',
    'governance.act.delegate.hint': 'Os votos só contam depois de delegados - a ti, ou a quem vote por ti.',
    'governance.act.delegate.self': 'Delegar em mim',
    'governance.act.delegate.submit': 'Delegar',
    'governance.act.delegate.placeholder': 'Endereço, ou vazio para o teu',
    'governance.act.delegate.token': 'Token de voto:',
    'governance.act.badAddress': 'Isso não é um endereço.',
