...
export const tr: Dictionary = {
    ...
    'governance.hint': 'Bu zincirdeki bir yöneticinin kaydettiği her öneri, kendi yazdığı olaylardan okunur.',
    'governance.governors': 'Yöneticiler',
    'governance.governor.unnamed': 'Adsız yönetici',
    'governance.governor.proposals': '{count} öneri',
    'governance.filter': 'Sonuç',
    'governance.filter.open': 'Açık',
    'governance.filter.passed': 'Kabul',
    'governance.filter.failed': 'Ret',
    'governance.filter.governor': 'Yönetici',
    'governance.untitled': 'Başlıksız öneri',
    'governance.proposedBy': 'Öneren',
    'governance.voters': '{count} oy veren',
    'governance.ends.block': 'Oylama {block} numaralı blokta kapanır',
    'governance.ended.block': 'Oylama {block} numaralı blokta kapandı',
    'governance.ends.date': 'Oylama {date} kapanır',
    'governance.ended.date': 'Oylama {date} kapandı',
    'governance.empty.chain.title': 'Bu zincirde yönetici yok',
    'governance.empty.chain.hint': 'Bu bölüm kendini bulur: bir yönetici yayına alınıp ilk önerisini kaydettiğinde görünür.',
    'governance.empty.title': 'Henüz öneri yok',
    'governance.empty.hint': 'Bir öneri, oluşturulması dizine girer girmez burada belirir.',
    'governance.empty.filtered.title': 'Eşleşen öneri yok',
    'governance.empty.filtered.hint': 'Bu kayıtta o daraltmaya uyan bir şey yok.',
    'governance.total': '{count} öneri kayıtlı.',
    'governance.state.pending': 'Beklemede',
    'governance.state.active': 'Oylamada',
    'governance.state.canceled': 'İptal',
    'governance.state.defeated': 'Reddedildi',
    'governance.state.succeeded': 'Kabul edildi',
    'governance.state.queued': 'Sırada',
    'governance.state.expired': 'Süresi doldu',
    'governance.state.executed': 'Yürütüldü',
    'governance.state.closed': 'Kapandı',
    'governance.support.for': 'Lehte',
    'governance.support.against': 'Aleyhte',
    'governance.support.abstain': 'Çekimser',
    'governance.support.other': 'Diğer',
    'governance.share': '%{percent}',
    'governance.quorum': 'Yeter sayı',
    'governance.quorum.unknown': 'Bu yönetici, önerinin hangi yeter sayıya ihtiyaç duyduğunu söylemedi.',
    'governance.tally': 'Oylama',
    'governance.proposal.title': 'Öneri',
    'governance.proposal.missing.title': 'Böyle bir öneri yok',
    'governance.proposal.missing.hint': 'Bu yönetici için o kimlikte hiçbir şey dizine alınmadı.',
    'governance.live': 'yönetici {state} diyor',
    'governance.governor': 'Yönetici',
    'governance.id': 'Öneri kimliği',
    'governance.voteStart': 'Oylama açılışı',
    'governance.voteEnd': 'Oylama kapanışı',
    'governance.atBlock': 'Blok {block}',
    'governance.counting': 'Sayım',
    'governance.timeline': 'Geçmiş',
    'governance.stage.created': 'Önerildi',
    'governance.stage.queued': 'Sıraya alındı',
    'governance.stage.executed': 'Yürütüldü',
    'governance.stage.canceled': 'İptal edildi',
    'governance.eta': '{date} tarihinden itibaren yürütülebilir',
    'governance.description': 'Önerinin metni',
    'governance.description.none': 'Bu önerinin açıklaması yok.',
    'governance.calls': 'Ne yapıyor',
    'governance.calls.none': 'Bu öneri hiçbir şeyi çağırmıyor',
    'governance.calls.none.hint': 'Zincirde bir şey taşımak yerine bir tutumu kaydeder.',
    'governance.call.to': 'Kime',
    'governance.call.value': 'Değer',
    'governance.call.data': 'Calldata',
    'governance.ballots': 'Oylar ({count})',
    'governance.ballots.empty': 'Henüz oy yok',
    'governance.ballots.empty.hint': 'Bu öneriye verilen her oy, ağırlığı ve gerekçesiyle burada görünür.',
    'governance.act.title': 'Katıl',
    'governance.act.connect': 'Oy vermek, devretmek ya da bir öneriyi ilerletmek için bu zincirde bir cüzdan bağlayın.',
    'governance.act.vote': 'Oyunuz',
    'governance.act.submit': 'Oy ver',
    'governance.act.reason': 'Gerekçe',
    'governance.act.reason.placeholder': 'Neden böyle oy verdiniz (isteğe bağlı)',
    'governance.act.power': 'Anlık görüntüdeki oy gücünüz: {weight}',
    'governance.act.voted': 'Bu öneriye zaten oy verdiniz.',
    'governance.act.sent': 'Cüzdanınıza gönderildi.',
    'governance.act.queue': 'Sıraya al',
    'governance.act.queue.hint': 'Bu öneri kabul edildi. Sıraya almak zaman kilidini başlatır.',
    'governance.act.execute': 'Yürüt',
    'governance.act.execute.hint': 'Zaman kilidi bu öneriyi tutuyor. Yürütmek çağrılarını çalıştırır.',
    'governance.act.delegate': 'Oy gücü',
    'governance.act.delegate.hint': 'Oylar ancak devredildikten sonra sayılır - kendinize ya da sizin adınıza oy verecek birine.',
    'governance.act.delegate.self': 'Kendime devret',
    'governance.act.delegate.submit': 'Devret',
    'governance.act.delegate.placeholder': 'Adres, ya da kendiniz için boş',
    'governance.act.delegate.token': 'Oy tokenı:',
    'governance.act.badAddress': 'Bu bir adres değil.',
