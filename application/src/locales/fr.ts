...
export const fr: Dictionary = {
    ...
    'governance.hint': 'Chaque proposition qu’un gouverneur de cette chaîne a enregistrée, lue dans les événements qu’il a lui-même écrits.',
    'governance.governors': 'Gouverneurs',
    'governance.governor.unnamed': 'Gouverneur sans nom',
    'governance.governor.proposals': '{count} propositions',
    'governance.filter': 'Résultat',
    'governance.filter.open': 'Ouvertes',
    'governance.filter.passed': 'Adoptées',
    'governance.filter.failed': 'Rejetées',
    'governance.filter.governor': 'Gouverneur',
    'governance.untitled': 'Proposition sans titre',
    'governance.proposedBy': 'Proposée par',
    'governance.voters': '{count} votants',
    'governance.ends.block': 'Le vote se clôt au bloc {block}',
    'governance.ended.block': 'Le vote s’est clos au bloc {block}',
    'governance.ends.date': 'Le vote se clôt le {date}',
    'governance.ended.date': 'Le vote s’est clos le {date}',
    'governance.empty.chain.title': 'Aucun gouverneur sur cette chaîne',
    'governance.empty.chain.hint': 'Cette section se trouve toute seule : elle apparaît dès qu’un gouverneur est déployé et enregistre sa première proposition.',
    'governance.empty.title': 'Aucune proposition pour l’instant',
    'governance.empty.hint': 'Une proposition apparaît ici dès que sa création est indexée.',
    'governance.empty.filtered.title': 'Aucune proposition ne correspond',
    'governance.empty.filtered.hint': 'Rien dans ce registre ne correspond à ce filtre.',
    'governance.total': '{count} propositions enregistrées.',
    'governance.state.pending': 'En attente',
    'governance.state.active': 'En vote',
    'governance.state.canceled': 'Annulée',
    'governance.state.defeated': 'Rejetée',
    'governance.state.succeeded': 'Adoptée',
    'governance.state.queued': 'En file',
    'governance.state.expired': 'Expirée',
    'governance.state.executed': 'Exécutée',
    'governance.state.closed': 'Close',
    'governance.support.for': 'Pour',
    'governance.support.against': 'Contre',
    'governance.support.abstain': 'Abstention',
    'governance.support.other': 'Autre',
    'governance.share': '{percent} %',
    'governance.quorum': 'Quorum',
    'governance.quorum.unknown': 'Ce gouverneur n’a pas dit quel quorum la proposition demandait.',
    'governance.tally': 'Le vote',
    'governance.proposal.title': 'Proposition',
    'governance.proposal.missing.title': 'Proposition introuvable',
    'governance.proposal.missing.hint': 'Rien n’a été indexé sous cet identifiant pour ce gouverneur.',
    'governance.live': 'le gouverneur indique {state}',
    'governance.governor': 'Gouverneur',
    'governance.id': 'Identifiant',
    'governance.voteStart': 'Ouverture du vote',
    'governance.voteEnd': 'Clôture du vote',
    'governance.atBlock': 'Bloc {block}',
    'governance.counting': 'Décompte',
    'governance.timeline': 'Historique',
    'governance.stage.created': 'Proposée',
    'governance.stage.queued': 'Mise en file',
    'governance.stage.executed': 'Exécutée',
    'governance.stage.canceled': 'Annulée',
    'governance.eta': 'Exécutable à partir du {date}',
    'governance.description': 'La proposition',
    'governance.description.none': 'Cette proposition ne porte aucune description.',
    'governance.calls': 'Ce qu’elle fait',
    'governance.calls.none': 'Cette proposition n’appelle rien',
    'governance.calls.none.hint': 'Elle enregistre une position plutôt que de déplacer quoi que ce soit sur la chaîne.',
    'governance.call.to': 'Vers',
    'governance.call.value': 'Valeur',
    'governance.call.data': 'Calldata',
    'governance.ballots': 'Bulletins ({count})',
    'governance.ballots.empty': 'Aucun bulletin pour l’instant',
    'governance.ballots.empty.hint': 'Chaque vote émis sur cette proposition apparaît ici, avec son poids et son motif.',
    'governance.act.title': 'Participer',
    'governance.act.connect': 'Connectez un portefeuille sur cette chaîne pour voter, déléguer ou faire avancer une proposition.',
    'governance.act.vote': 'Votre vote',
    'governance.act.submit': 'Voter',
    'governance.act.reason': 'Motif',
    'governance.act.reason.placeholder': 'Pourquoi vous avez voté ainsi (facultatif)',
    'governance.act.power': 'Votre poids de vote à l’instantané : {weight}',
    'governance.act.voted': 'Vous avez déjà voté sur cette proposition.',
    'governance.act.sent': 'Envoyé à votre portefeuille.',
    'governance.act.queue': 'Mettre en file',
    'governance.act.queue.hint': 'Cette proposition est adoptée. La mettre en file lance son verrou temporel.',
    'governance.act.execute': 'Exécuter',
    'governance.act.execute.hint': 'Le verrou temporel détient cette proposition. L’exécuter lance ses appels.',
    'governance.act.delegate': 'Poids de vote',
    'governance.act.delegate.hint': 'Les voix ne comptent qu’une fois déléguées - à vous-même, ou à quelqu’un qui vote pour vous.',
    'governance.act.delegate.self': 'Déléguer à moi-même',
    'governance.act.delegate.submit': 'Déléguer',
    'governance.act.delegate.placeholder': 'Adresse, ou vide pour la vôtre',
    'governance.act.delegate.token': 'Jeton de vote :',
    'governance.act.badAddress': 'Ce n’est pas une adresse.',
