...
export const fr: Dictionary = {
    ...
    // --- Verified source ----------------------------------------------------------------------
    'contract.verified.full': 'Source vérifiée',
    'contract.verified.partial': 'Source vérifiée - correspondance partielle',
    'contract.verified.detail': '{name}, compilé avec solc {compiler}',
    'contract.verified.partial.hint': 'Le code déployé correspond ; seule la queue de métadonnées diffère, et un commentaire déplacé ou un autre chemin de fichier suffit à la changer. Les instructions sont prouvées, les commentaires autour ne le sont pas.',
    'contract.verified.viaImplementation': 'La source publiée est celle de l’implémentation vers laquelle cette adresse renvoie.',
    'contract.source': 'Code source',
    'contract.source.optimized': 'optimiseur activé, {runs} passes',
    'contract.source.unoptimized': 'optimiseur désactivé',
    'contract.source.copyAbi': 'Copier l’ABI',

    // --- Publishing source --------------------------------------------------------------------
    'verify.cta': 'Publier la source',
    'verify.title': 'Vérifier {short}',
    'verify.heading': 'Publier et vérifier la source',
    'verify.intro': 'Rien ici n’est pris pour argent comptant. Cet explorateur compile ce que vous envoyez et ne l’accepte que si le résultat est le bytecode déjà déployé à cette adresse - aucun compte à créer, personne à attendre.',
    'verify.offline': 'La liste des compilateurs n’a pas pu être récupérée : seules les versions déjà présentes sur ce serveur sont utilisables. Demandez à son exploitant d’ajouter celle qu’il vous faut.',
    'verify.kind': 'Format de soumission',
    'verify.kind.single': 'Fichier unique',
    'verify.kind.json': 'Standard JSON',
    'verify.compiler': 'Version du compilateur',
    'verify.compiler.hint': 'La version exacte, pas seulement la release - la sortie de solc change d’un correctif à l’autre. Un point marque les versions déjà présentes sur ce serveur.',
    'verify.evmVersion': 'Version de l’EVM',
    'verify.evmVersion.default': 'Valeur par défaut du compilateur',
    'verify.evmVersion.hint': 'Laissez la valeur par défaut sauf si le contrat a été compilé avec un réglage explicite. En nommer une autre change les opcodes produits.',
    'verify.name': 'Nom du contrat',
    'verify.name.hint': 'Facultatif. Laissé vide, chaque contrat de la source est essayé.',
    'verify.fileName': 'Nom du fichier',
    'verify.fileName.hint': 'Le chemin sous lequel le fichier a été compilé. Il entre dans le hachage des métadonnées : un chemin erroné transforme une correspondance complète en correspondance partielle.',
    'verify.optimizer': 'Optimiseur',
    'verify.optimizer.enabled': 'Activé',
    'verify.optimizer.hint': 'Ces réglages doivent être ceux du déploiement, sinon le bytecode ne correspondra pas.',
    'verify.runs': 'Passes de l’optimiseur',
    'verify.license': 'Licence',
    'verify.source': 'Source Solidity',
    'verify.source.placeholder': 'Collez le contrat entier, imports compris.',
    'verify.json': 'Entrée Standard JSON',
    'verify.json.placeholder': 'Collez l’entrée solc standard-json produite par votre build.',
    'verify.json.hint': 'Ses réglages sont repris tels quels - remappings, adresses de bibliothèques et viaIR compris. Seule la sélection de sortie est élargie.',
    'verify.submit': 'Vérifier et publier',
    'verify.submit.hint': 'La compilation prend quelques secondes, et une seule soumission tourne à la fois.',
    'verify.failed.hint': 'Un écart vient presque toujours de la version du compilateur, du réglage de l’optimiseur ou du nombre de passes. Comparez chacun à ce qui a servi au déploiement.',
    'verify.done.detail': 'La source de {name} est désormais publiée sur ce contrat, et ses fonctions sont nommées et appelables.',
    'verify.done.open': 'Ouvrir le contrat',
