...
export const hi: Dictionary = {
    ...
    'governance.hint': 'इस चेन के किसी गवर्नर ने जो भी प्रस्ताव दर्ज किया, वह उसी की लिखी घटनाओं से पढ़ा गया।',
    'governance.governors': 'गवर्नर',
    'governance.governor.unnamed': 'बिना नाम का गवर्नर',
    'governance.governor.proposals': '{count} प्रस्ताव',
    'governance.filter': 'परिणाम',
    'governance.filter.open': 'खुले',
    'governance.filter.passed': 'पारित',
    'governance.filter.failed': 'अस्वीकृत',
    'governance.filter.governor': 'गवर्नर',
    'governance.untitled': 'बिना शीर्षक प्रस्ताव',
    'governance.proposedBy': 'प्रस्तावक',
    'governance.voters': '{count} मतदाता',
    'governance.ends.block': 'मतदान ब्लॉक {block} पर बंद होगा',
    'governance.ended.block': 'मतदान ब्लॉक {block} पर बंद हुआ',
    'governance.ends.date': 'मतदान {date} को बंद होगा',
    'governance.ended.date': 'मतदान {date} को बंद हुआ',
    'governance.empty.chain.title': 'इस चेन पर कोई गवर्नर नहीं',
    'governance.empty.chain.hint': 'यह हिस्सा खुद मिल जाता है: गवर्नर तैनात होते ही और पहला प्रस्ताव दर्ज होते ही दिखने लगता है।',
    'governance.empty.title': 'अभी कोई प्रस्ताव नहीं',
    'governance.empty.hint': 'प्रस्ताव यहाँ उसी क्षण आ जाता है जब उसका बनना अनुक्रमित हो जाता है।',
    'governance.empty.filtered.title': 'कोई प्रस्ताव मेल नहीं खाता',
    'governance.empty.filtered.hint': 'इस रिकॉर्ड में उस छँटाई से कुछ मेल नहीं खाता।',
    'governance.total': '{count} प्रस्ताव दर्ज हैं।',
    'governance.state.pending': 'प्रतीक्षित',
    'governance.state.active': 'मतदान जारी',
    'governance.state.canceled': 'रद्द',
    'governance.state.defeated': 'अस्वीकृत',
    'governance.state.succeeded': 'पारित',
    'governance.state.queued': 'कतार में',
    'governance.state.expired': 'समय समाप्त',
    'governance.state.executed': 'निष्पादित',
    'governance.state.closed': 'बंद',
    'governance.support.for': 'पक्ष',
    'governance.support.against': 'विपक्ष',
    'governance.support.abstain': 'तटस्थ',
    'governance.support.other': 'अन्य',
    'governance.share': '{percent}%',
    'governance.quorum': 'कोरम',
    'governance.quorum.unknown': 'इस गवर्नर ने नहीं बताया कि प्रस्ताव को कितने कोरम की ज़रूरत थी।',
    'governance.tally': 'मतदान',
    'governance.proposal.title': 'प्रस्ताव',
    'governance.proposal.missing.title': 'ऐसा कोई प्रस्ताव नहीं',
    'governance.proposal.missing.hint': 'इस गवर्नर के लिए उस आईडी पर कुछ अनुक्रमित नहीं है।',
    'governance.live': 'गवर्नर {state} बताता है',
    'governance.governor': 'गवर्नर',
    'governance.id': 'प्रस्ताव आईडी',
    'governance.voteStart': 'मतदान शुरू',
    'governance.voteEnd': 'मतदान समाप्त',
    'governance.atBlock': 'ब्लॉक {block}',
    'governance.counting': 'गणना',
    'governance.timeline': 'इतिहास',
    'governance.stage.created': 'प्रस्तावित',
    'governance.stage.queued': 'कतार में',
    'governance.stage.executed': 'निष्पादित',
    'governance.stage.canceled': 'रद्द',
    'governance.eta': '{date} से निष्पादन योग्य',
    'governance.description': 'प्रस्ताव का पाठ',
    'governance.description.none': 'इस प्रस्ताव में कोई विवरण नहीं है।',
    'governance.calls': 'यह क्या करता है',
    'governance.calls.none': 'यह प्रस्ताव कुछ नहीं बुलाता',
    'governance.calls.none.hint': 'यह चेन पर कुछ हिलाने के बजाय एक रुख दर्ज करता है।',
    'governance.call.to': 'किसे',
    'governance.call.value': 'मूल्य',
    'governance.call.data': 'कॉलडेटा',
    'governance.ballots': 'मत ({count})',
    'governance.ballots.empty': 'अभी कोई मत नहीं',
    'governance.ballots.empty.hint': 'इस प्रस्ताव पर पड़ा हर मत अपने भार और कारण के साथ यहाँ दिखता है।',
    'governance.act.title': 'भाग लें',
    'governance.act.connect': 'मत देने, प्रत्यायोजित करने या प्रस्ताव आगे बढ़ाने के लिए इसी चेन पर वॉलेट जोड़ें।',
    'governance.act.vote': 'आपका मत',
    'governance.act.submit': 'मत दें',
    'governance.act.reason': 'कारण',
    'governance.act.reason.placeholder': 'आपने ऐसा मत क्यों दिया (वैकल्पिक)',
    'governance.act.power': 'स्नैपशॉट पर आपकी मत-शक्ति: {weight}',
    'governance.act.voted': 'आप इस प्रस्ताव पर पहले ही मत दे चुके हैं।',
    'governance.act.sent': 'आपके वॉलेट को भेजा गया।',
    'governance.act.queue': 'कतार में डालें',
    'governance.act.queue.hint': 'यह प्रस्ताव पारित हुआ। कतार में डालने से इसका टाइमलॉक शुरू होता है।',
    'governance.act.execute': 'निष्पादित करें',
    'governance.act.execute.hint': 'टाइमलॉक के पास यह प्रस्ताव है। निष्पादन इसकी कॉलें चलाता है।',
    'governance.act.delegate': 'मत-शक्ति',
    'governance.act.delegate.hint': 'मत तभी गिने जाते हैं जब वे प्रत्यायोजित हों - खुद को, या किसी ऐसे को जो आपकी ओर से मत दे।',
    'governance.act.delegate.self': 'खुद को प्रत्यायोजित करें',
    'governance.act.delegate.submit': 'प्रत्यायोजित करें',
    'governance.act.delegate.placeholder': 'पता, या अपने लिए खाली छोड़ें',
    'governance.act.delegate.token': 'मत टोकन:',
    'governance.act.badAddress': 'यह कोई पता नहीं है।',
