...
export const ar: Dictionary = {
    ...
    'governance.hint': 'كل اقتراح سجّله حاكم على هذه السلسلة، مقروءًا من الأحداث التي كتبها بنفسه.',
    'governance.governors': 'الحُكّام',
    'governance.governor.unnamed': 'حاكم بلا اسم',
    'governance.governor.proposals': '{count} اقتراح',
    'governance.filter': 'النتيجة',
    'governance.filter.open': 'مفتوح',
    'governance.filter.passed': 'أُقرّ',
    'governance.filter.failed': 'سقط',
    'governance.filter.governor': 'الحاكم',
    'governance.untitled': 'اقتراح بلا عنوان',
    'governance.proposedBy': 'اقترحه',
    'governance.voters': '{count} مصوّت',
    'governance.ends.block': 'ينتهي التصويت عند الكتلة {block}',
    'governance.ended.block': 'انتهى التصويت عند الكتلة {block}',
    'governance.ends.date': 'ينتهي التصويت {date}',
    'governance.ended.date': 'انتهى التصويت {date}',
    'governance.empty.chain.title': 'لا حاكم على هذه السلسلة',
    'governance.empty.chain.hint': 'يظهر هذا القسم من تلقاء نفسه حالما يُنشر حاكم ويسجّل أول اقتراح له.',
    'governance.empty.title': 'لا اقتراحات بعد',
    'governance.empty.hint': 'يظهر الاقتراح هنا لحظة فهرسة إنشائه.',
    'governance.empty.filtered.title': 'لا اقتراح مطابق',
    'governance.empty.filtered.hint': 'لا شيء في هذا السجل يطابق ذلك التضييق.',
    'governance.total': 'سُجّل {count} اقتراح.',
    'governance.state.pending': 'منتظر',
    'governance.state.active': 'قيد التصويت',
    'governance.state.canceled': 'مُلغى',
    'governance.state.defeated': 'ساقط',
    'governance.state.succeeded': 'ناجح',
    'governance.state.queued': 'في الطابور',
    'governance.state.expired': 'منتهٍ',
    'governance.state.executed': 'مُنفّذ',
    'governance.state.closed': 'مغلق',
    'governance.support.for': 'مع',
    'governance.support.against': 'ضد',
    'governance.support.abstain': 'ممتنع',
    'governance.support.other': 'أخرى',
    'governance.share': '{percent}٪',
    'governance.quorum': 'النصاب',
    'governance.quorum.unknown': 'لم يقل هذا الحاكم ما النصاب الذي احتاجه الاقتراح.',
    'governance.tally': 'التصويت',
    'governance.proposal.title': 'اقتراح',
    'governance.proposal.missing.title': 'لا اقتراح بهذا المعرّف',
    'governance.proposal.missing.hint': 'لم يُفهرس شيء بهذا المعرّف لهذا الحاكم.',
    'governance.live': 'يقول الحاكم {state}',
    'governance.governor': 'الحاكم',
    'governance.id': 'معرّف الاقتراح',
    'governance.voteStart': 'يفتح التصويت',
    'governance.voteEnd': 'يغلق التصويت',
    'governance.atBlock': 'الكتلة {block}',
    'governance.counting': 'طريقة العدّ',
    'governance.timeline': 'التاريخ',
    'governance.stage.created': 'اقتُرح',
    'governance.stage.queued': 'دخل الطابور',
    'governance.stage.executed': 'نُفّذ',
    'governance.stage.canceled': 'أُلغي',
    'governance.eta': 'قابل للتنفيذ من {date}',
    'governance.description': 'نص الاقتراح',
    'governance.description.none': 'لا نص لهذا الاقتراح.',
    'governance.calls': 'ماذا يفعل',
    'governance.calls.none': 'لا يستدعي هذا الاقتراح شيئًا',
    'governance.calls.none.hint': 'يسجّل موقفًا بدل أن ينقل شيئًا على السلسلة.',
    'governance.call.to': 'إلى',
    'governance.call.value': 'القيمة',
    'governance.call.data': 'البيانات',
    'governance.ballots': 'الأصوات ({count})',
    'governance.ballots.empty': 'لا أصوات بعد',
    'governance.ballots.empty.hint': 'كل صوت يُدلى به على هذا الاقتراح يظهر هنا بوزنه وسببه.',
    'governance.act.title': 'شارك',
    'governance.act.connect': 'اربط محفظة على هذه السلسلة للتصويت أو التفويض أو تمرير اقتراح.',
    'governance.act.vote': 'صوتك',
    'governance.act.submit': 'أدلِ بصوتك',
    'governance.act.reason': 'السبب',
    'governance.act.reason.placeholder': 'لماذا صوّتّ هكذا (اختياري)',
    'governance.act.power': 'وزن صوتك عند اللقطة: {weight}',
    'governance.act.voted': 'لقد صوّتّ على هذا الاقتراح من قبل.',
    'governance.act.sent': 'أُرسل إلى محفظتك.',
    'governance.act.queue': 'إلى الطابور',
    'governance.act.queue.hint': 'أُقرّ هذا الاقتراح. إدخاله الطابور يبدأ قفله الزمني.',
    'governance.act.execute': 'نفّذ',
    'governance.act.execute.hint': 'القفل الزمني يحتجز هذا الاقتراح. التنفيذ يُجري استدعاءاته.',
    'governance.act.delegate': 'وزن التصويت',
    'governance.act.delegate.hint': 'لا تُحسب الأصوات إلا بعد تفويضها - إليك، أو إلى من يصوّت عنك.',
    'governance.act.delegate.self': 'أفوّض نفسي',
    'governance.act.delegate.submit': 'فوّض',
    'governance.act.delegate.placeholder': 'عنوان، أو اتركه فارغًا لنفسك',
    'governance.act.delegate.token': 'رمز التصويت:',
    'governance.act.badAddress': 'هذا ليس عنوانًا.',
