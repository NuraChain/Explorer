...
export const ar: Dictionary = {
    ...
    // --- Verified source ----------------------------------------------------------------------
    'contract.verified.full': 'الكود المصدري موثَّق',
    'contract.verified.partial': 'الكود المصدري موثَّق - تطابق جزئي',
    'contract.verified.detail': '{name}، مُصرَّف بـ solc {compiler}',
    'contract.verified.partial.hint': 'الكود المنشور مطابق؛ الاختلاف في ذيل البيانات الوصفية وحده، ويكفي لذلك تعليق أُزيح مكانه أو مسار ملف مختلف. التعليمات مثبتة، أما التعليقات المحيطة بها فلا.',
    'contract.verified.viaImplementation': 'الكود المنشور يخص التنفيذ الذي يحيل إليه هذا العنوان.',
    'contract.source': 'الكود المصدري',
    'contract.source.optimized': 'المُحسِّن مفعَّل، {runs} جولة',
    'contract.source.unoptimized': 'المُحسِّن معطَّل',
    'contract.source.copyAbi': 'نسخ ABI',

    // --- Publishing source --------------------------------------------------------------------
    'verify.cta': 'نشر الكود المصدري',
    'verify.title': 'توثيق {short}',
    'verify.heading': 'نشر الكود المصدري وتوثيقه',
    'verify.intro': 'لا شيء هنا يُؤخذ على الثقة. يُصرِّف هذا المستكشف ما ترسله ولا يقبله إلا إذا كانت النتيجة هي البايت-كود المنشور فعلاً على هذا العنوان - فلا حساب يُنشأ ولا أحد يُنتظر.',
    'verify.offline': 'تعذَّر جلب قائمة المُصرِّفات، لذا لا يمكن استخدام سوى النسخ الموجودة على هذا الخادم. اطلب ممن يديره إضافة النسخة التي تحتاجها.',
    'verify.kind': 'صيغة الإرسال',
    'verify.kind.single': 'ملف واحد',
    'verify.kind.json': 'Standard JSON',
    'verify.compiler': 'إصدار المُصرِّف',
    'verify.compiler.hint': 'الإصدار بعينه لا الرقم وحده - مخرجات solc تتغير بين الإصدارات التصحيحية. النقطة تدل على النسخ الموجودة على هذا الخادم.',
    'verify.evmVersion': 'نسخة EVM',
    'verify.evmVersion.default': 'الافتراضي للمُصرِّف',
    'verify.evmVersion.hint': 'اتركه على الافتراضي ما لم يكن العقد قد بُني بقيمة محددة. اختيار الخطأ يغيّر رموز العمليات الناتجة.',
    'verify.name': 'اسم العقد',
    'verify.name.hint': 'اختياري. إن تُرك فارغاً جُرِّب كل عقد في المصدر.',
    'verify.fileName': 'اسم الملف',
    'verify.fileName.hint': 'المسار الذي صُرِّف الملف تحته. يدخل في تجزئة البيانات الوصفية، فالمسار الخطأ يحوّل التطابق الكامل إلى جزئي.',
    'verify.optimizer': 'المُحسِّن',
    'verify.optimizer.enabled': 'مفعَّل',
    'verify.optimizer.hint': 'يجب أن تطابق ما نُشر به العقد، وإلا فلن يطابق البايت-كود.',
    'verify.runs': 'جولات المُحسِّن',
    'verify.license': 'الرخصة',
    'verify.source': 'مصدر Solidity',
    'verify.source.placeholder': 'الصق العقد كاملاً بما فيه الاستيرادات.',
    'verify.json': 'مدخل Standard JSON',
    'verify.json.placeholder': 'الصق مدخل solc standard-json الذي أنتجه البناء لديك.',
    'verify.json.hint': 'تُستخدم إعداداته كما كُتبت تماماً - بما فيها remappings وعناوين المكتبات وviaIR. لا يُوسَّع سوى اختيار المخرجات.',
    'verify.submit': 'وثِّق وانشر',
    'verify.submit.hint': 'يستغرق التصريف بضع ثوانٍ، ويُنفَّذ إرسال واحد في كل مرة.',
    'verify.failed.hint': 'عدم التطابق يعود غالباً إلى إصدار المُصرِّف أو إعداد المُحسِّن أو عدد الجولات. قارن كلاً منها بما نُشر به العقد.',
    'verify.done.detail': 'صار مصدر {name} منشوراً على هذا العقد، ودوالُّه الآن مسمّاة وقابلة للاستدعاء.',
    'verify.done.open': 'افتح العقد',
