...
export const fa: Dictionary = {
    ...
    'governance.hint': 'هر پیشنهادی که حاکمی روی این زنجیره ثبت کرده، خوانده از رویدادهایی که خودش نوشته است.',
    'governance.governors': 'حاکمان',
    'governance.governor.unnamed': 'حاکم بی‌نام',
    'governance.governor.proposals': '{count} پیشنهاد',
    'governance.filter': 'نتیجه',
    'governance.filter.open': 'باز',
    'governance.filter.passed': 'تصویب‌شده',
    'governance.filter.failed': 'ردشده',
    'governance.filter.governor': 'حاکم',
    'governance.untitled': 'پیشنهاد بی‌عنوان',
    'governance.proposedBy': 'پیشنهاد از',
    'governance.voters': '{count} رأی‌دهنده',
    'governance.ends.block': 'رأی‌گیری در بلاک {block} بسته می‌شود',
    'governance.ended.block': 'رأی‌گیری در بلاک {block} بسته شد',
    'governance.ends.date': 'رأی‌گیری {date} بسته می‌شود',
    'governance.ended.date': 'رأی‌گیری {date} بسته شد',
    'governance.empty.chain.title': 'حاکمی روی این زنجیره نیست',
    'governance.empty.chain.hint': 'این بخش خودش پیدا می‌شود: همین که حاکمی مستقر شود و نخستین پیشنهادش را ثبت کند.',
    'governance.empty.title': 'هنوز پیشنهادی نیست',
    'governance.empty.hint': 'پیشنهاد همان لحظه که ساختش نمایه شود اینجا می‌آید.',
    'governance.empty.filtered.title': 'پیشنهادی مطابق نیست',
    'governance.empty.filtered.hint': 'در این کارنامه چیزی با این محدودسازی جور نیست.',
    'governance.total': '{count} پیشنهاد ثبت شده است.',
    'governance.state.pending': 'در انتظار',
    'governance.state.active': 'در حال رأی‌گیری',
    'governance.state.canceled': 'لغوشده',
    'governance.state.defeated': 'ردشده',
    'governance.state.succeeded': 'تصویب‌شده',
    'governance.state.queued': 'در صف',
    'governance.state.expired': 'منقضی',
    'governance.state.executed': 'اجراشده',
    'governance.state.closed': 'بسته',
    'governance.support.for': 'موافق',
    'governance.support.against': 'مخالف',
    'governance.support.abstain': 'ممتنع',
    'governance.support.other': 'دیگر',
    'governance.share': '{percent}٪',
    'governance.quorum': 'حد نصاب',
    'governance.quorum.unknown': 'این حاکم نگفت که این پیشنهاد به چه حد نصابی نیاز داشت.',
    'governance.tally': 'رأی‌گیری',
    'governance.proposal.title': 'پیشنهاد',
    'governance.proposal.missing.title': 'چنین پیشنهادی نیست',
    'governance.proposal.missing.hint': 'با این شناسه چیزی برای این حاکم نمایه نشده است.',
    'governance.live': 'حاکم می‌گوید {state}',
    'governance.governor': 'حاکم',
    'governance.id': 'شناسهٔ پیشنهاد',
    'governance.voteStart': 'آغاز رأی‌گیری',
    'governance.voteEnd': 'پایان رأی‌گیری',
    'governance.atBlock': 'بلاک {block}',
    'governance.counting': 'شیوهٔ شمارش',
    'governance.timeline': 'تاریخچه',
    'governance.stage.created': 'پیشنهاد شد',
    'governance.stage.queued': 'به صف رفت',
    'governance.stage.executed': 'اجرا شد',
    'governance.stage.canceled': 'لغو شد',
    'governance.eta': 'از {date} قابل اجراست',
    'governance.description': 'متن پیشنهاد',
    'governance.description.none': 'این پیشنهاد متنی ندارد.',
    'governance.calls': 'چه می‌کند',
    'governance.calls.none': 'این پیشنهاد چیزی را صدا نمی‌زند',
    'governance.calls.none.hint': 'موضعی را ثبت می‌کند، نه اینکه چیزی را روی زنجیره جابه‌جا کند.',
    'governance.call.to': 'به',
    'governance.call.value': 'مقدار',
    'governance.call.data': 'داده',
    'governance.ballots': 'رأی‌ها ({count})',
    'governance.ballots.empty': 'هنوز رأیی نیست',
    'governance.ballots.empty.hint': 'هر رأیی که به این پیشنهاد داده شود، با وزن و دلیلش اینجا می‌آید.',
    'governance.act.title': 'مشارکت',
    'governance.act.connect': 'برای رأی دادن، تفویض یا گذراندن یک پیشنهاد، کیف‌پولی روی همین زنجیره وصل کنید.',
    'governance.act.vote': 'رأی شما',
    'governance.act.submit': 'ثبت رأی',
    'governance.act.reason': 'دلیل',
    'governance.act.reason.placeholder': 'چرا این‌طور رأی دادید (اختیاری)',
    'governance.act.power': 'وزن رأی شما در لحظهٔ ثبت: {weight}',
    'governance.act.voted': 'شما پیش‌تر به این پیشنهاد رأی داده‌اید.',
    'governance.act.sent': 'به کیف‌پول شما فرستاده شد.',
    'governance.act.queue': 'به صف',
    'governance.act.queue.hint': 'این پیشنهاد تصویب شد. فرستادنش به صف، قفل زمانی‌اش را آغاز می‌کند.',
    'governance.act.execute': 'اجرا',
    'governance.act.execute.hint': 'قفل زمانی این پیشنهاد را نگه داشته است. اجرا، فراخوانی‌هایش را انجام می‌دهد.',
    'governance.act.delegate': 'وزن رأی',
    'governance.act.delegate.hint': 'رأی‌ها تنها وقتی شمرده می‌شوند که تفویض شده باشند - به خودتان، یا به کسی که جای شما رأی می‌دهد.',
    'governance.act.delegate.self': 'تفویض به خودم',
    'governance.act.delegate.submit': 'تفویض',
    'governance.act.delegate.placeholder': 'نشانی، یا خالی برای خودتان',
    'governance.act.delegate.token': 'توکن رأی:',
    'governance.act.badAddress': 'این یک نشانی نیست.',
